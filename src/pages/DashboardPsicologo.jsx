...
import { PatientListCard } from '../components/PatientListCard'; // <- IMPORTADO AQUI
...
export const DashboardPsicologo = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Lista de Pacientes + Próximos Agendamentos */}
      {!isNewPsychologist && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <PatientListCard patients={patients} />

          <div className="rounded-lg p-6 bg-white/60 shadow-md">
