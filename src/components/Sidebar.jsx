...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed left-0 top-0 h-full w-64 bg-[#a7eff1] shadow-xl transform transition-transform duration-300 z-40 ${
        isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
      }`}>
        <div className="flex flex-col h-full">
          {/* Logo */}
          <div className="flex items-center space-x-3 p-6 border-b border-dark/10">
            <img src="/logo.png" alt="Lyra" className="w-10 h-10 rounded-lg" />
            <div>
              <span className="text-xl font-bold text-blue-900">Lyra</span>
              <p className="text-xs text-blue-900/70">Sistema Psicológico</p>
            </div>
          </div>
          ...
          <div className="p-6 border-b border-white/10">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-900/70 capitalize">{user?.type}</p>
              </div>
            </div>
          </div>
            ...
            <ul className="space-y-2">
              {navLinks.map(link => (
                <li key={link.to}>
                  ...
                  >
                    <link.icon size={20} className="text-blue-900" />
          ...
          <div className="p-4 border-t border-white/10">
            <button
              ...
              className="flex items-center space-x-3 w-full px-4 py-3 text-blue-900 hover:bg-white/20 rounded-xl transition-colors"
            >
